...
# study_lsvc.optimize(lambda trial: objective(trial, "xgb"), n_trials=100)
# best_params_lsvc = study_lsvc.best_params

# # Optimize hyperparameters for Decision Trees
# study_dt = optuna.create_study(direction='maximize')
# study_dt.optimize(lambda trial: objective(trial, "xgb"), n_trials=100)
...
with open(f"{output_dir}/UNSW-NB15_rf_hyperparameters.json", "w") as f:
